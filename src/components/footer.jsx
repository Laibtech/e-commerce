    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  TLahor,Pakistan</p> </div>
          ...
          <Link to='/z' id='footer-link' target='_blank' className='gap-3'>
          <BsSlack />
          </Link>
          </div>
        </div>
        <div className="col-md-2 col-lg-2 mb-3 mb-md-0">
          ...
          <div className='mb-3'> <Link to='/about' id='footer-links'>About </Link>  </div>
        ...
        <div className="col-md-2 col-lg-2 mb-3 mb-md-0">
          ...
          <div className='mb-3'> <Link to='/login' id='footer-links'>Home</Link>  </div>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Laib dev 2023</p>
        </div>
        <div className="col-12 col-md-6">
