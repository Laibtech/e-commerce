  ...
  <section className="about-us p-5">
    <div className="row">
      ...
      <div className="col-md-6 d-flex flex-column align-items-center justify-content-center">
        ...
        <p className="card-text mb-3">At LA mart, we are more than just a retail store; we are a team of dedicated individuals committed to providing you with the best shopping experience possible.</p>
        <p className="card-text">Our vision is to create a shopping destination where quality, convenience, and affordability come together. We believe that shopping should be enjoyable and stress-free, and we work tirelessly to make that vision a reality.<br />We are proud to be part of a vibrant community, and we actively engage in supporting local initiatives and charities. Giving back is at the core of who we are. </p>
      </div>
    </div>
  </section>
