        ...
        <div className="col-lg-6 col-md-12">
            <div className="card p-5">
                <h2 className='footer-title mb-3'><b>Contact Us</b></h2>
                  <p className='mb-2'><b>Address:</b> Lahore,Pakistan</p>
                  ...
                  <p>Have questions or feedback? We would love to hear from you! Please donot hesitate to reach out to us. Your inquiries and comments are important to us, and we will do our best to assist you promptly.</p>
                  <p>If you prefer to send us a message online, you can use the contact form below. Simply fill in your name, email address, and your message, and we will get back to you as soon as possible.</p>
            </div>
          </div>
      </div>
    </div>
